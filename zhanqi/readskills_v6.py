...
class hero_card(object):
    ...
    def get_desc(self,skill_id,skill_level):
    ...
    def write_info_to_excel(self):#深入抽取信息 and 写入表格
        #初始化，实例化类的方法
        mycalss=hero_card()
        fun1=mycalss.all_cards_id()
        fun2=mycalss.all_cards()
        fun3=mycalss.all_cards_unlockskill()
        fun4=mycalss.get_desc()
        #参数化数据存放
        ...
        row_2_part_2=['skillId1','skillLevel1',
...
if __name__=="__main__":
    ...
    print len(test01.all_cards_unlockskill())
