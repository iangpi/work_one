...
def login_cnblogs(username,password):
    #一直没有添加driver的path地址，所以总会报错，driver的path地址不对（第二作者留）
    driver_path = os.path.abspath(r"C:\Users\EDZ\AppData\Local\Google\Chrome\Application\chromedriver.exe")
    driver = webdriver.Chrome(driver_path)
    try:
        # 1、输入账号密码回车
        driver.implicitly_wait(3)
        driver.get('http://admin.dev.lkker.cn/admin/login')
        #driver.get('https://passport.cnblogs.com/user/signin')

        input_username = driver.find_element_by_xpath('//*[@id="login_form"]/div[1]/input')
        input_pwd = driver.find_element_by_xpath('//*[@id="login_form"]/div[2]/input')
        signin = driver.find_element_by_xpath('//*[@id="login_form"]/button')
...
if __name__ == '__main__':
    #login_cnblogs(username='1131337751@qq.com',password='1234!sdf')
    login_cnblogs(username='lkker_admin ',password='lkker_admin_1025')
